...
from v03_pipeline.lib.reference_datasets.gencode.mapping_gene_ids import load_gencode_ensembl_to_refseq_id
...
gencode_ensembl_to_refseq_id_mapping = hl.literal(load_gencode_ensembl_to_refseq_id(GENCODE_FOR_VEP_RELEASE))
